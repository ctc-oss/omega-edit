...
struct omega_model_struct {
    FILE *file_ptr_{};                       ///< File being edited (open for read)
    std::string file_path_{};                ///< File path being edited
    omega_changes_t changes_{};              ///< Collection of changes for this session, ordered by time
    omega_changes_t changes_undone_{};       ///< Undone changes that are eligible for being redone
    omega_model_segments_t model_segments_{};///< Model segment vector
};
