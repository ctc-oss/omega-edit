...
int main(int /*argc*/, char ** /*argv*/) {
    ...
    auto viewport1_ptr = omega_edit_create_viewport(session_ptr.get(), 0, 100, 0, vpt_change_cbk, &view_mode);
    ...
    omega_edit_insert_string(session_ptr.get(), 0, "++++");
    if (0 != omega_check_model(session_ptr.get())) { clog << __LINE__ << " session model has errors\n"; }
    auto viewport2_ptr = omega_edit_create_viewport(session_ptr.get(), 50, 10, 0, vpt_change_cbk, &view_mode);
