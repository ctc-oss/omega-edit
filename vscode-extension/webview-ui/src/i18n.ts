...
const englishStrings = {
  ...
  transform: {
    ...
    searchTransforms: 'Find transform',
    searchTransformsTitle: 'Filter transform plugins by name, id, operation, or help text',
    noTransformMatches: 'No matching transforms',
    ...
    transformDescriptorNotice:
      'Content-changing transforms record this descriptor in TRANSFORM.data.',
    inspectDescriptorNotice:
      'Inspect-only transforms use this descriptor but do not dirty the session.',
    apply: 'Apply',
    cancel: 'Cancel',
    ...
    presetHistoryTitle: 'Open recent transform presets',
    presetHistoryLabel: 'Recent transform presets',
    openPreset: (name: string) => `Open ${name} preset`,
    metadataTitle: 'Open last transform metadata',
    metadataLabel: 'Last transform metadata',
    metadataSummary: (name: string, serial: string) =>
      `${name} | serial ${serial}`,
    metadataNoSerial: 'none',
    metadataOperation: 'Operation',
    metadataSerial: 'Serial',
    metadataRange: 'Range',
    metadataReplacement: 'Replacement',
    metadataComputedSize: 'Computed size',
