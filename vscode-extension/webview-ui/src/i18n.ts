...
const englishStrings = {
  ...
  search: {
    ...
    hex: 'Hex',
    hexTitle: 'Toggle hex search mode',
    hexDisabledCase: 'Hex mode ignores letter case',
    matchCase: 'Match case',
    matchCaseTitle: 'Toggle case-sensitive search',
    toggleReplace: 'Toggle replace',
    close: 'Close search',
    closeTitle: 'Close find panel (Escape)',
    ...
    replaceAllConfirm: 'Replace all matches?',
    noSearch: 'No search',
  ...
  inspector: {
    ...
    float64: 'float64',
    groupCommon: 'Common',
    groupIntegers: 'Integers',
    groupFloats: 'Floats',
    groupText: 'Text',
    groupToggle: (label: string) => `Toggle ${label} group`,
...
const localeOverrides: Record<string, LocaleStringOverrides> = {
  es: {
    ...
    search: {
      ...
      hex: 'Hex',
      hexTitle: 'Alternar modo de busqueda hexadecimal',
      hexDisabledCase: 'El modo hex ignora mayusculas/minisculas',
      matchCase: 'Distinguir mayusculas',
      matchCaseTitle: 'Alternar busqueda sensible a mayusculas',
      toggleReplace: 'Alternar reemplazar',
      close: 'Cerrar busqueda',
      closeTitle: 'Cerrar panel de busqueda (Escape)',
      previous: 'Anterior',
      next: 'Siguiente',
      ...
      replaceAllConfirm: 'Reemplazar todas las coincidencias?',
    ...
    inspector: {
      ...
      groupCommon: 'Comun',
      groupIntegers: 'Enteros',
      groupFloats: 'Flotantes',
      groupText: 'Texto',
      groupToggle: (label: string) => `Alternar grupo ${label}`,
