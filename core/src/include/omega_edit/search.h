 ...
 */
OMEGA_EDIT_EXPORT omega_search_context_t *
omega_search_create_context(omega_session_t *session_ptr, const char *pattern, int64_t pattern_length,
                            int64_t session_offset, int64_t session_length, int case_insensitive,
                            int is_reverse_search);
 ...
 */
OMEGA_EDIT_EXPORT int omega_search_context_is_reverse_search(const omega_search_context_t *search_context_ptr);
 ...
 */
OMEGA_EDIT_EXPORT int64_t omega_search_context_get_session_length(const omega_search_context_t *search_context_ptr);
 ...
 */
OMEGA_EDIT_EXPORT int64_t omega_search_context_get_session_offset(const omega_search_context_t *search_context_ptr);
 ...
 */
OMEGA_EDIT_EXPORT int64_t omega_search_context_get_match_offset(const omega_search_context_t *search_context_ptr);
 ...
 */
OMEGA_EDIT_EXPORT int64_t omega_search_context_get_pattern_length(const omega_search_context_t *search_context_ptr);
