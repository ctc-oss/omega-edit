...
int main(int argc, char *argv[]) {
    ...
    omega_session_character_counts(session_ptr, character_counts_ptr, 0, omega_session_get_computed_file_size(session_ptr));

    printf("File: %s, BOM: %s\n", argv[1], omega_util_BOM_to_string(omega_character_counts_get_BOM(character_counts_ptr)));
